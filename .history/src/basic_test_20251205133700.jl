...
Plots.plot!(p, t, low, color=:green, ls=:dash, label="90% CI", alpha=0.5)
...
@benchmark BayesBSpline.eval_posterior_splines1($bsmc, $t)
@benchmark BayesBSpline.eval_posterior_splines2($bsmc, $t)