...
"""
    quantile(θ::AbstractMatrix{T}, basis::A, t::AbstractVector{T}, q::T) where {T<:Real, A<:AbstractBSplineBasis}
    quantile(θ::AbstractMatrix{T}, basis::A, t::AbstractVector{T}, q::AbstractVector{T}) where {T<:Real, A<:AbstractBSplineBasis}
...
function Distributions.quantiles(θ::AbstractMatrix{T}, basis::A, t::AbstractVector{T}, q::T) where {T<:Real, A<:AbstractBSplineBasis}
    if !(0 ≤ q ≤ 1)
