...
Note that the binning is only used as part of the model fitting procedure, and the structure of the resulting fitted `BSMChains` model object is the same regardless of whether the binning step is performed or not.
