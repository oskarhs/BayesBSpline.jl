...
function Base.show(io::IO, ::MIME"text/plain", bsmc::BSMChains{T, M, V})
    println(io, "BSMChains{", T, "} object holding ", bsmc.n_samples, " posterior samples, including ", bsmc.n_burnin, " burn-in samples.")
